...
<div class="quoteflex-quote quoteflex-template-boxed" data-quote-id="<?php echo esc_attr( $quote->id ); ?>">
	<div class="quoteflex-box">
		<div class="quoteflex-quote-icon">"</div>
