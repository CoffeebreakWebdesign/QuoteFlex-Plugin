...
<div class="quoteflex-quote quoteflex-template-default" data-quote-id="<?php echo esc_attr( $quote->id ); ?>">
	...
	<?php if ( $enable_refresh ) : ?>
		<button 
			...
			data-template="<?php echo esc_attr( isset( $args['template'] ) ? $args['template'] : 'default' ); ?>"
